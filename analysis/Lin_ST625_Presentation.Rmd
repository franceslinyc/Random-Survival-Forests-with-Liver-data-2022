...
The log-rank test statistic is used by default in the **R** package `randomForestSRC` uses since log-rank test has traditionally been used for testing two-sample survival data. 
